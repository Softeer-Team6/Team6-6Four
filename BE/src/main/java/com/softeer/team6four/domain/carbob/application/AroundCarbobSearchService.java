...
public class AroundCarbobSearchService {
            ...
            (Double latitude, Double longitude)
    {
        ...
        List<AroundCarbobListInfoSummary> aroundCarbobList =  aroundCarbobRepository.findAllWithInCircleAreaSummary(point, 5000);
            ...
            (Double latitude, Double longitude, String sortType)
    {
        ...
        List<AroundCarbobListInfo> aroundCarbobList =  aroundCarbobRepository.findAllWithInCircleArea(point, 5000, sortType);
            ...
            (Double latitude, Double longitude, Long carbobId)
    {
        ...
        SpecificDetailCarbobInfo specificCarbob = aroundCarbobRepository.findSpecificCarbobDetailByCarbobId(point,carbobId);
